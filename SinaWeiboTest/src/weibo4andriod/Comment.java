...
public class Comment extends WeiboResponse implements java.io.Serializable {
    ...
    /*package*/Comment(Response res, Weibo4sina weibo) throws WeiboException {
        super(res);
    ...
    /*package*/Comment(Response res, Element elem, Weibo4sina weibo) throws
            WeiboException {
        super(res);
        init(res, elem, weibo);
    }
    ...
    private void init(Response res, Element elem, Weibo4sina weibo) throws
            WeiboException {
    ...
    /*package*/
    static List<Comment> constructComments(Response res,Weibo4sina weibo) throws WeiboException {
