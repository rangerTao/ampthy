...
public class ListObject extends WeiboResponse implements java.io.Serializable {
	...
	/*package*/ListObject(Response res, Weibo4sina weibo) throws WeiboException {
		super(res);
		init(res, res.asDocument().getDocumentElement(), weibo);
	}

	/*package*/ListObject(Response res, Element elem, Weibo4sina weibo) throws WeiboException {
		super(res);
		init(res, elem, weibo);
	}
	...
	private void init(Response res, Element elem, Weibo4sina weibo) throws WeiboException {
	 ...
	 */
	/*package*/static ListObjectWapper constructListObjects(Response res, Weibo4sina weibo) throws WeiboException {
