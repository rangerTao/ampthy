...
public class Tag extends WeiboResponse implements java.io.Serializable{
	...
	public Tag(Response res ,Element elem,Weibo4sina weibo,String str) throws WeiboException{
		ensureRootNodeNameIs("tagid", elem);
		id=elem.getNodeName();
		value=elem.getNodeValue();
	}
	public Tag(Response res,Element elem,Weibo4sina weibo) throws WeiboException{
		ensureRootNodeNameIs("tagid", elem);
		id=elem.getNodeName();
		value=elem.getNodeValue();
	}
	...
	public static List<Tag> constructTags(Response res,Weibo4sina weibo) throws WeiboException {
    ...
    public static List<Tag> createTags(Response res,Weibo4sina weibo) throws WeiboException{
		Document doc=res.asDocument();
		if(isRootNodeNilClasses(doc)){
			return new ArrayList<Tag>(0);
		}else{
    ...
    public static List<Tag> destroyTags(Response res,Weibo4sina weibo) throws WeiboException{
		Document doc=res.asDocument();
		if(isRootNodeNilClasses(doc)){
			return new ArrayList<Tag>(0);
		}else{
